...
| [teams](teams/) | Scour Microsoft Teams channels via Graph API using the browser session for auth | `upskill amol-anand/skills --skill teams` |
...
```bash
upskill amol-anand/skills --skill handoff
```
